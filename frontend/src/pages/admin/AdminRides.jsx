...
export default function AdminRides() {
  ...
  function handleAssignDriver(ride) {
    navigate(
      `/admin/cars?assignRide=${ride._id}&preferredCar=${ride.carId || ""}`,
      {
        state: {
          rideDetails: {
            id: ride._id,
  ...
  const stats = {
    ...
    active: allRides.filter(r => r.rideStatus === "active").length,
        ...
        {loading ? (
          ...
          >
            {rides.map((ride, index) => {
              const displayStatus = ride.rideStatus;
