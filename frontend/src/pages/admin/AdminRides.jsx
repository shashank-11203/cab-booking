...
export default function AdminRides() {
  ...
  function handleAssignDriver(ride) {
    ...
    console.log("Assign driver to ride:", ride._id);
  }
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {filterButtons.map(btn => (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => setFilter(btn.value)}
                className={`px-6 py-2.5 rounded-lg font-medium transition-all duration-200 ${filter === btn.value
                  ? "bg-yellow-400 text-black shadow-md"
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <h3 className="text-xl font-bold text-gray-900">
                          Ride #{ride._id?.slice(-6).toUpperCase() || 'N/A'}
                        </h3>
                      </div>
                    ...
                    <div className="space-y-3 mb-4 pb-4 border-b border-gray-200">
                      ...
                      <div className="flex items-start gap-3">
                        <div className="mt-1 p-2 rounded-lg bg-red-100">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                      <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-50">
                        ...
                        <span className="text-sm text-gray-900 font-medium">
                          {ride.date ? formatDate(ride.date) : 'N/A'}
                        </span>
                      </div>
                      <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-50">
                    ...
                    <div className="space-y-2 mb-4 pb-4 border-b border-gray-200">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-gray-600">Preferred Car</span>
                        </div>
                      ...
                      {hasAssignedCar && (
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-600">Assigned Car</span>
                          </div>
                    ...
                    {ride.rideStatus === "cancelled" && (
                      <div className="mt-2 mb-4 flex items-center justify-between">
                        ...
                        <span className={`text-sm font-semibold ${refundInfo.color}`}>
                          {refundInfo.label}
                        </span>
                      </div>
                    )}
